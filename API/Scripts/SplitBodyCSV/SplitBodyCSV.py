...
# Date: 17 Mar 2023
"""Split body in active component in Fusion360, as defined in split body csv
file.
...
def run(context):
    ...
    ui = None
    try:
        title = 'Split body from csv file'
        ...
        # Split body from CSV file in activeComponent
        splitbody.split_body_from_csv_file(ui, title, filename, activeComponent)
