...
# Date: 17 Mar 2023
"""Split bodies from split body csv files in folder, in active component in
   Fusion360.

See API/libraries/splitbody.py
"""
...
def run(context):
    ...
    ui = None
    try:
        title = 'Split bodies from split body csv files in folder'
        ...
        # Split bodies in activeComponent from CSV files in folderName
        splitbody.split_bodies_from_csv_files(ui, title, folderName, activeComponent)
