...
# Date: 17 Mar 2023
"""Create a plane from three points defined in a plane csv file
into the active component in Fusion360.
...
def run(context):
    ...
    ui = None
    try:
        title = 'Create plane from plane csv file'
        ...
        # Create plane from CSV file in activeComponent
        createplane.create_plane_from_csv_file(ui, title, filename, activeComponent)
