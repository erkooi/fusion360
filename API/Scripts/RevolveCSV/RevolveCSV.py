...
# Date: 17 Jul 2023
"""Revolve sketch profile in active component in Fusion360, as defined in
revolve csv file.

See API/libraries/revolve.py
"""
...
def run(context):
    ...
    ui = None
    try:
        title = 'Revolve sketch profile from csv file'
        ...
        # Revolve sketch profile from CSV file in activeComponent
        revolve.revolve_from_csv_file(ui, title, filename, activeComponent)
